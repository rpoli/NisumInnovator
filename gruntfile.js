module.exports = function( grunt ) {
    ...
    grunt.initConfig( {
        ...
        copy: {
            ...
            js: {
                files: [ {
                        ...
                        src: [ '*.js' ],
                        dest: 'public/lib/bootstrap/js',
                        expand: true
                    }, {
                        cwd: 'bower_components/bootstrap/less',
                        src: [ '*.less' ],
                        dest: 'public/lib/bootstrap/less',
                        expand: true
                    }, {
                        cwd: 'bower_components/bootstrap/docs/assets/css',
                        src: [ '*.*' ],
                        dest: 'public/lib/bootstrap/docs/assets/css',
                        expand: true
                    }, {
                        cwd: 'bower_components/bootstrap/docs/assets/ico',
                        src: [ '*.*' ],
                        dest: 'public/lib/bootstrap/docs/assets/ico',
                        expand: true
                    }, {
                        cwd: 'bower_components/bootstrap/docs/assets/img',
                        src: [ '*.*' ],
                        dest: 'public/lib/bootstrap/docs/assets/img',
                        expand: true
                    }, {
                        cwd: 'bower_components/bootstrap/docs/assets/js',
                        src: [ '*.*' ],
                        dest: 'public/lib/bootstrap/docs/assets/js',
                        expand: true
                    }, {
        ...
        jsbeautifier: {
            "default": {
                src: [ "*.js", "app/**/*.js", "app/**/**/*.js", "config/*.js", "config/**/*.js", "public/js/*.js", "public/js/**/*.js", "public/views/*.html", "public/views/*.html",
                    "public/views/**/*.html", "public/css/*.css", "public/css/**/*.css"
                ]
            },
            "git-pre-commit": {
                src: [ "src/**/*.js" ],
    ...
    //Default task(s).
    grunt.registerTask( 'default', [ 'copy', 'jshint', 'jsbeautifier', 'concurrent' ] );
